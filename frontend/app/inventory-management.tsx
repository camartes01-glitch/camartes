...
const styles = StyleSheet.create({
  ...
  // Autocomplete styles
  autocompleteContainer: { position: 'relative', zIndex: 10, marginBottom: spacing.sm },
  inputRow: { flexDirection: 'row', alignItems: 'center' },
  inputDisabled: { backgroundColor: colors.gray[100], color: colors.gray[500] },
  clearBtn: { position: 'absolute', right: spacing.sm },
  dropdownList: {
    position: 'absolute',
    top: '100%',
    left: 0,
  ...
  // QC Photo styles
  qcButtonRow: { flexDirection: 'row', justifyContent: 'flex-start', gap: spacing.sm, marginTop: spacing.sm },
  qcButton: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: spacing.sm, paddingVertical: 6, backgroundColor: colors.gray[100], borderRadius: borderRadius.sm },
  qcButtonText: { ...typography.caption, fontWeight: '600' },
  uploadButton: { marginVertical: spacing.md },
  uploadGradient: { alignItems: 'center', justifyContent: 'center', paddingVertical: spacing.xl, borderRadius: borderRadius.lg, borderWidth: 2, borderStyle: 'dashed', borderColor: colors.secondary[400] },
  uploadText: { ...typography.body, fontWeight: '600', color: colors.secondary[700], marginTop: spacing.sm },
  uploadSubtext: { ...typography.caption, color: colors.gray[500], marginTop: 4 },
  photoGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.md },
  photoItem: { width: (width - spacing.lg * 2 - spacing.sm * 2) / 3, height: 100, borderRadius: borderRadius.md, overflow: 'hidden', position: 'relative' },
  photoImage: { width: '100%', height: '100%', resizeMode: 'cover' },
  photoDeleteButton: { position: 'absolute', top: 4, right: 4, width: 24, height: 24, borderRadius: 12, backgroundColor: colors.error, justifyContent: 'center', alignItems: 'center' },
  photoDate: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'rgba(0,0,0,0.6)', paddingVertical: 2, paddingHorizontal: 4 },
